...
function goMsg(res, array){
    if(res.status == 'data'){
        console.log("Response in Go goMsg", res);
    }else if(res.status == 'html'){
        var display_div = array['div'];
        if (typeof array !== "undefined" && array.div) {
            document.getElementById(display_div).innerHTML = res.html;
        }
    }else{
